...
**Usage**
```bash
python syosetu_downloader.py <book_url> [options]
```
...
**Examples**
```bash
python syosetu_downloader.py https://ncode.syosetu.com/abcd1234/
```

```bash
python syosetu_downloader.py https://ncode.syosetu.com/abcd1234/ -f txt -o downloads
```

```bash
python syosetu_downloader.py https://ncode.syosetu.com/abcd1234/ -c 10-25
```

```bash
python syosetu_downloader.py https://ncode.syosetu.com/abcd1234/ -v 1,3-4
```

```bash
python syosetu_downloader.py https://ncode.syosetu.com/abcd1234/ --vertical
```

```bash
python syosetu_downloader.py https://ncode.syosetu.com/abcd1234/12/
```
